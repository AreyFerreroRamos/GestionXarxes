...
# Descripció: Activació d'un agent SNMP al server.
...
#	'snmptable -v 2c -c 41588224-S 192.0.2.24 UCD-SNMP-MIB::prTable'
#	'snmptable -v 2c -c 41588224-S 192.0.2.24 ucdavis.dskTable'
#	'snmptable -v 2c -c 41588224-S 192.0.2.24 ucdavis.laTable'
