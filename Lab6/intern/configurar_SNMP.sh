...
# Descripció: Activació d'un agent SNMP a l'intern.
...
#	'snmptable -v 2c -c 41588224-S 172.22.2.126 UCD-SNMP-MIB::prTable'
#	'snmptable -v 2c -c 41588224-S 172.22.2.126 ucdavis.dskTable'
#	'snmptable -v 2c -c 41588224-S 172.22.2.126 ucdavis.laTable'
