...
cp -p hosts /etc
# Si es vol validar la connexió de l'intern amb el router utilitzant el nom assignat, es pot executar la comanda 'ping router'.
# Si es vol validar la connexió de l'intern amb el server utilitzant el nom assignat, es pot executar la comanda 'ping server'.
